...
runService.RenderStepped:Connect(function()
    for target, _ in pairs(ESP.Players) do
        if target.Character and target.Character:FindFirstChild("HumanoidRootPart") and target.Character:FindFirstChild("Humanoid") and target.Character:FidnFirstChild("Head") and target.Character:FindFirstChild("Humanoid").Health > 0.2 and localPlayer and localPlayer.Character and localPlayer.Character:FindFirstChild("HumanoidRootPart") then
